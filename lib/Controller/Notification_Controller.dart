...
class NotificationController extends GetxController {
  ...
  final List<Map<String, String?>> _dummyTemplates = [
    ...
    {
      'message': 'Berkas Notaris #N-045 berhasil diverifikasi',
      'ppatId': null,
    },
    {
    ...
    {
      'message': 'Proses berkas #N-051 telah selesai',
      'ppatId': null,
    },
    {
  ...
  // Panggil ini saat user sudah login
  void startListening(String userId) {
    print("🚀 [NotificationController] startListening dipanggil, userId=$userId, useDummyMode=$useDummyMode");
  ...
  Future<void> _showLocalNotification(WsNotification notif) async {
    try {
      ...
      print("🔔 [NotificationController] Notif lokal berhasil ditampilkan: ${notif.message}");
    } catch (e) {
