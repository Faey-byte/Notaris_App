...
class NotifikasiController extends GetxController {
  ...
  Future<void> fetchNotifikasi() async {
    ...
    try {
      // Simulasi mengambil data dari API / Delay Jaringan
      await Future.delayed(const Duration(seconds: 1));

      // Data dummy menyesuaikan tema Notaris / PPAT
      final dummyData = [
        {
          "id": 1,
          "title": "Status Berkas Diperbarui",
          "message": "Berkas PPAT atas nama Rustafff telah diubah statusnya menjadi REVISI.",
          "type": "berkas",
        ...
        },
        {
          ...
          "message": "Status pajak untuk AJB No. 98 berhasil diverifikasi oleh sistem.",
          "type": "pembayaran",
      ...
      notifikasiList.value = dummyData.map((json) => NotifikasiModel.fromJson(json)).toList();
    } catch (e) {
  ...
  void markAsRead(int id) {
    ...
    if (index != -1) {
      ...
      notifikasiList.refresh(); // Memicu pembaruan UI secara reaktif
      // Di sini kamu bisa menambahkan API call ke endpoint update status read
    }
  }
